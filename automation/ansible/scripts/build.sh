...
cat > /tmp/simple-utcd.service << 'EOF'
[Unit]
Description=Simple NFS Daemon
Documentation=https://github.com/blburns/simple-utcd
...
User=utcddev
Group=utcddev
ExecStart=/opt/simple-utcd/build/simple-utcd --config /etc/simple-utcd/simple-utcd.conf
...
ProtectHome=true
ReadWritePaths=/opt/simple-utcd
...
sudo cp /tmp/simple-utcd.service /etc/systemd/system/
...
# Set permissions
sudo chown utcddev:utcddev /etc/simple-utcd/simple-utcd.conf
sudo chmod 644 /etc/simple-utcd/simple-utcd.conf

echo "=== Build Complete ==="
echo "To start the service:"
echo "  sudo systemctl enable simple-utcd"
echo "  sudo systemctl start simple-utcd"
echo ""
echo "To check status:"
echo "  sudo systemctl status simple-utcd"
echo ""
echo "To view logs:"
echo "  sudo journalctl -u simple-utcd -f"
echo ""
echo "To test NFS:"
