...
REMOTE_PROJECT_DIR="/opt/simple-utcd"
...
- name: Collect packages from remote VMs
  ...
  vars:
    ...
    remote_dist_dir: "/opt/simple-utcd/dist"
    remote_build_dir: "/opt/simple-utcd/build"
    remote_centralized_dir: "/opt/simple-utcd/dist/centralized/v$VERSION"
