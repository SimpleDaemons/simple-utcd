...
# Docker deployment script for Simple UTC Daemon
...
# Build and deploy
echo "Deploying simple-utcd with profile: $PROFILE"
...
case $PROFILE in
    ...
    "runtime")
        ...
        docker-compose --profile runtime up -d simple-utcd
